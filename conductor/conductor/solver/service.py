        ...
        while self.running:
            ...
            try:
                ...
                if len(countries) != 0:
                    ...
                    LOG.info("No '*' wild card entry found in country latency table. No solution will be provided")
                    p.message = "No '*' wild card entry found in country latency table. No solution will be provided"
            ...
            if not solution_list or len(solution_list) < 1:
                ...
                for solution in solution_list:
                    ...
                    for demand_name in solution:
                        ...
                        elif rec["candidate"]["inventory_type"] == "cloud" and resource.get('conflict_id'):
