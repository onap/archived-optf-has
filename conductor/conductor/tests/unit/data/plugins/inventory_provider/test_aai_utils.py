...
from conductor.data.plugins.inventory_provider.aai_utils import *
...
class TestUtils(unittest.TestCase):
    ...
    def test_convert_hyphen_to_under_score(self):
        ...
        self.assertEqual(converted_slice_profile, convert_hyphen_to_under_score(slice_profile_hyphened))
    ...
    def test_get_first_level_and_second_level_filter(self):
        ...
        self.assertEqual(second_level_filter, get_first_level_and_second_level_filter(filtering_attributes,
                                                                                                  "service_instance"))

        self.assertEqual(first_level_filter, filtering_attributes)

        self.assertEqual({}, get_first_level_and_second_level_filter(filtering_attributes, "service_instance"))
    ...
    def test_add_query_params(self):
        ...
        self.assertEqual(query_params, add_query_params(first_level_filter))
        first_level_filter = {}
        self.assertEqual('', add_query_params(first_level_filter))
    ...
    def test_add_query_params_and_depth(self):
        ...
        self.assertEqual(query_params_with_depth, add_query_params_and_depth(first_level_filter, "2"))

        only_depth = "?depth=2"
        first_level_filter = {}
        self.assertEqual(only_depth, add_query_params_and_depth(first_level_filter, "2"))
    ...
    def test_get_inv_values_for_second_level_filter(self):
        ...
        self.assertEqual(inventory_attribute, get_inv_values_for_second_level_filter(second_level_filter,nssi_instance))
