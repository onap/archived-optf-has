...
class TestNoExceptionTranslator(unittest.TestCase):
    def setUp(self):
        ...
        self.Translator = Translator(
            self.conf, template_name, str(uuid.uuid4()), template)
    ...
    def test_error_version_validation(self, mock_create):
    ...
    @patch('conductor.controller.translator.Translator.create_components')
    def test_validation_complete(self, mock_create):
    ...
    def test_do_translation(self, mock_cons, mock_resv,
                            mock_dmd, mock_opt, mock_loc):
        self.Translator.create_components()
        expected_format = {
            "conductor_solver": {
                "version": '',
    ...
    def test_translate(self, mock_create, mock_validate,
                       mock_do_trans, mock_parse):
