...
class TestNoExceptionTranslator(unittest.TestCase):
    ...
    @patch('conductor.controller.translator.Translator.setup_rpc')
    def test_create_correct_components(self, mock_rpc):
    ...
    @patch('conductor.controller.translator.Translator.setup_rpc')
    def test_parse_constraints(self, mock_rpc):
    ...
    @patch('conductor.controller.translator.Translator.setup_rpc')
    def test_parse_optimization(self, mock_rpc):
    ...
    @patch('conductor.controller.translator.Translator.setup_rpc')
    def test_do_translation(self, mock_rpc, mock_loc, mock_opt,
