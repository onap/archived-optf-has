...
from conductor.solver.optimizer.constraints.aggregation import CrossDemandAttributeAggregation
...
class TestAggregation(unittest.TestCase):
    ...
    def test_solve(self):
        ...
        aggregation_obj = CrossDemandAttributeAggregation('urllc_aggregation', 'aggregation',
                                                          ['URLLC', 'ran'],
