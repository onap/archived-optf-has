...
CPS_OPTS = [
    ...
    cfg.StrOpt('server_url_version',
               default='v1',
               help='The version of CPS in v# format.'),
...
class CPS(object):
    ...
    def __init__(self):
        ...
        self.version = self.conf.cps.server_url_version.rstrip('/')
    ...
    def _cps_versioned_path(self, path):
        """Return a URL path with the CPS version prepended"""
    ...
    def get_cps_response(self,args):
        raw_path = self.conf.cps.get_ta_list_url
        path = self._cps_versioned_path(raw_path)
        data = {}
