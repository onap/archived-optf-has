...
class AAI(base.InventoryProviderBase):
        ...
        for name, requirements in demands.items():
            ...
            for requirement in requirements:
                ...
                if inventory_type == 'cloud':
                    ...
                    if filtering_attributes and model_invariant_id:
                        resolved_demands[name] = self.get_nssi_candidates_from_aai(filtering_attributes,
    ...
    def get_nssi_candidates_from_aai(self, filtering_attributes, model_invariant_id, model_version_id, service_role):
        ...
        return self.get_nssi_candidates(aai_response.json(), filtering_attributes)

    def get_nssi_candidates(self, response_body, filtering_attributes):
