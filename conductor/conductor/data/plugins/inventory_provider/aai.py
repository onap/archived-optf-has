...
class AAI(base.InventoryProviderBase):
            ...
            for requirement in requirements:
                ...
                if inventory_type == 'cloud':
                    ...
                    for region_id, region in regions.items():
                        ...
                        info = self.build_candidate_info('aai', inventory_type, self.conf.data.cloud_candidate_cost,
                        ...
                        other['sriov_automation'] = 'true' if self.check_sriov_automation(cloud['cloud_region_version'],
                                                                                name, info['candidate_id']) else 'false'
                    ...
                    for vnf in generic_vnf:
                        ...
                        if vs_cust_id and vs_cust_id == customer_id:
                            info = self.build_candidate_info('aai', inventory_type,
                        ...
                        for complex_link in self.resolve_v_server_and_complex_link_for_vnf(info['candidate_id'], cloud,
                                                                                           vnf, name, triage_translator_data,service_type):
                    ...
                    for vnf in generic_vnf:
                        ...
                        # INFO
                        info = self.build_candidate_info('aai', inventory_type, self.conf.data.service_candidate_cost,
    ...
    @staticmethod
    def add_passthrough_attributes(candidate, passthrough_attributes, demand_name, triage_translator_data):
