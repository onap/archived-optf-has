...
The value of ``homing_template_version`` tells HAS not only the format of the template but also features that will be validated and supported. The following values are supported: "2016-11-01", "2017-10-10", or "2018-02-01" in the initial release of HAS.
